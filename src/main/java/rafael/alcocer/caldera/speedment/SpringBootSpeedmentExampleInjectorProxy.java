 ...
 */
public final class SpringBootSpeedmentExampleInjectorProxy implements InjectorProxy {
    
    @Override
    public boolean isApplicable(Class<?> clazz) {
        return InjectorProxy.samePackageOrBelow(SpringBootSpeedmentExampleInjectorProxy.class).test(clazz);
    }
